    ...
    <div className="min-h-screen relative overflow-hidden bg-[#010108]">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="mb-12 text-center animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-3xl bg-primary-600 mb-8 shadow-2xl shadow-primary-600/30 ring-1 ring-primary-400/20">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-white tracking-tight drop-shadow-[0_0_40px_rgba(255,140,50,0.15)]">
            K<span className="text-primary-500">Market</span>
          </h1>
        ...
        <div className="text-center max-w-3xl mb-14">
          <div className="inline-flex items-center gap-3 mb-6">
            <div className="h-[1px] w-16 bg-gradient-to-r from-transparent to-primary-500/60" />
            <span className="text-primary-400/90 text-xs md:text-sm font-semibold uppercase tracking-[0.4em]">Coming Soon</span>
            <div className="h-[1px] w-16 bg-gradient-to-l from-transparent to-primary-500/60" />
          </div>
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Something amazing is<br />
            <span className="text-primary-500">on its way</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-4 gap-3 md:gap-5 mb-16 w-full max-w-xl">
          {[
            ...
            <div key={i} className="relative group">
              <div className="absolute -inset-[1px] bg-gradient-to-b from-primary-500/30 via-primary-300/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-700" />
        ...
        <div className="flex items-center gap-5">
          <a
            ...
            aria-label="Facebook"
            className="w-11 h-11 rounded-full bg-white/[0.05] border border-white/[0.1] flex items-center justify-center text-gray-400 hover:text-primary-400 hover:border-primary-500/40 hover:bg-primary-500/10 hover:shadow-[0_0_20px_rgba(255,140,50,0.15)] transition-all duration-300"
          >
